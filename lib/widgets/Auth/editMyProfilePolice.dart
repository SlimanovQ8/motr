...
import 'package:Motri/screens/ChangePasswordPolice.dart';
...
class EditMyProfilePolice extends StatefulWidget {
  MyProfile createState() => new MyProfile();
}

class MyProfile extends State<EditMyProfilePolice> {
    ...
    return new Container(
      ...
      child: FutureBuilder(
        future: FirebaseFirestore.instance
            .collection('MOI').where('MOINumber', isEqualTo : auth.currentUser.email).get(),
                    ...
                    child : Card(
                      ...
                      child: Container(
                        ...
                        child: ListTile(
                          ...
                          subtitle: Text(snapshot.data.docs[0].get('MOINumber')),
                        ),
                      ),
                    ),
                  ),
