      ...
      home: Scaffold(
        ...
        body: Container(
          ...
          child: Column(
            ...
            children: <Widget> [ Text('Thank you. Your request has been sent to MOI. Your Car will be added within 24 hour if it is yours', textAlign: TextAlign.center,
