...
class GenerateChildScreen extends StatefulWidget {
...
class GenerateScreenState extends State<GenerateChildScreen> {
        ...
        appBar: AppBar(
          ...
          leading:  IconButton(
            ...
            onPressed: () => Navigator.of(context).push(
              MaterialPageRoute(builder: (ctx) => ChildrenCodes()),),
