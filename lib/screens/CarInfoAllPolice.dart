...
import 'package:Motri/widgets/Auth/CarInfoPolice.dart';
...
void main() => runApp(AllCarInfoPolice());

class AllCarInfoPolice extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Police Car Info',
      ...
      home: Scaffold(
        appBar: AppBar(
          ...
          title: Text('Police Car Info', style: TextStyle(
              color: Colors.black
          ) ,)
          ,
