...
class MySelfCodeFromDisability extends StatefulWidget {
...
class GenerateScreenState extends State<MySelfCodeFromDisability> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('My Disability QR Code' , style: TextStyle(
            color: Colors.black,
          ),),
          leading:  IconButton(
        ...
        body: FutureBuilder(
            ...
            builder: (context, AsyncSnapshot <QuerySnapshot> snapshot)
            {
              ...
              {
                return _contentWidget(snapshot.data.docs[0].get('DisabilityNumber'));
              }
            }
        )
    );
